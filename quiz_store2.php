...
$qry="INSERT INTO `quiz_1232` (`id`, `name`, `token`, `qid`, `qname`, `option1_url`, `option2_url`, `option1_text`, `option2_text`, `answer`) VALUES (NULL, '$name', '$token', '$qid', '$qname', '$option1_url', '$option2_url', '$option1_text', '$option2_text', '$answer')";
